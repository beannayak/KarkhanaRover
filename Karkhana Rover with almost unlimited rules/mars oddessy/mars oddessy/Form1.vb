Public Class Form1
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If (Date.Now >= delayedCommandArrayTimeStamp(0)) Then
            ...
            swapDates()
            delay(100)           'give some time for transmit buffer to clear 

            Dim serialReturnValue As String
            serialReturnValue = SerialPort1.ReadExisting()
            If (InStr(serialReturnValue, "Mem", CompareMethod.Text) > 0) Then
                memFull = True
            End If
        End If
    End Sub
    ...
    Private Sub PictureBox1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox1.Click
        If (Not (memFull)) Then
            Form2.Show()
        Else
            MsgBox("Bot's Memory is full, No more room for rules available")
        End If
    End Sub
End Class
